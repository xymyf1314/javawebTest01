...
<body>
<div class="x-body">
    <form action="/servletTest03_war/userServlet?method=update" method="post" class="layui-form">
        <div class="layui-form-item">
            <label for="L_email" class="layui-form-label">
                <span class="x-red">*</span>ID
            </label>
            <div class="layui-input-inline">
                <input type="text"  name="id"  readonly="readonly" value=${user.id} required="required"
