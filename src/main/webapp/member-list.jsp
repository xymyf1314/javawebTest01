        ...
        <c:forEach  items="${users}" var="user">
          <tr>
            ...
            <td>${user.rdate}</td>
             <td>
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 <a title="编辑"  onclick="x_admin_show(this,'/servletTest03_war/userServlet?method=load&id=${user.id}')" href="javascript:;">
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
            var children = $(obj).parents("tr").children('.uid').text();
              //发异步删除数据
            $.ajax({
              url: '/servletTest03_war/userServlet?method=del&id',
              data: {
                "uid" : children
              },
              traditional: true,
