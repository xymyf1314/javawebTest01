...
<body class="login-bg">
    ...
    <div class="login layui-anim layui-anim-up">
        ...
        <form action="/servletTest03_war/login.demo01" method="post" class="layui-form" >
            ...
            <a href="javascript:;" onclick="document.getElementById('img').src='/servletTest03_war/checkcode/'+(new Date()).getTime()"><img id="img" style="background-color: #0C0C0C;width: 150px;height: 50px;margin-left: 50px;float:left" src="/servletTest03_war/checkcode" alt="点击刷新验证码"></a>
